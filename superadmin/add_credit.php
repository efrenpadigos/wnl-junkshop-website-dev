			...
			<body>
				...
				<div id='menu'>
					<?php include('template/menu.php'); ?>
						...
						<h1 style='color:maroon;border-bottom:1px solid #ccc;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ADD CREDIT</h1>
						
					</form>
								<table id=''>
									<thead>
										<div style='margin:auto;border:1px solid gray;width:50%;'>
											<div style='text-align:center;font-size:20px;'>ADD CREDIT</div>
											<br/>
											<div>Date<b>:</b><input type='text' name='' value=''></div>
											<br/>
											<div>Balance<b>:</b><input type='text' name='' value=''></div>
											<br/>
											<div>New Credit<b>:</b><input type='text' name='' value=''></div>
											</br>
											<div>Total Credit<b>:</b><input type='text' name='' value=''></div>
											</br>
											</select><a href='credit.php'>SAVE</a>
										</div>
