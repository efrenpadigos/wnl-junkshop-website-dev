<?php
	...
	if($count <= 0){
			echo"<script>alert('please pay later before buying.');window.location.href='sell.php'</script>";
	}
	else
	{
?>
...
<SCRIPT language=Javascript>
      function isNumberKey(evt)
      {
		...
		<?php
			$temp = $_GET['temp'];
			$query = mysql_query("select sum(total) from temp_sales_recycle") or die(mysql_error());
