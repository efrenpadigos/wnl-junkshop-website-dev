...
--
-- Host: localhost
-- Generation Time: Feb 20, 2016 at 10:13 PM
...
--
CREATE DATABASE `junkshop_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `junkshop_db`;
...
DROP TABLE IF EXISTS `admin_pos`;
...
(34, 'WNL mahayag', 'Mahayag Zamboanga del Sur', '500.00');
...
DROP TABLE IF EXISTS `collectors_credit`;
...
(28, 'kabilya', 'Solid Material(METAL)', 12, 'kg', '2016-02-10 07:09:20');
...
DROP TABLE IF EXISTS `posted_item`;
...
DROP TABLE IF EXISTS `recycled_item`;
...
DROP TABLE IF EXISTS `sales_recycle`;
...
DROP TABLE IF EXISTS `sell_recycled_item`;
...
DROP TABLE IF EXISTS `temp_recycled_item`;
...
DROP TABLE IF EXISTS `temp_sales_recycle`;
...
DROP TABLE IF EXISTS `temp_sell_recycle_item`;
...
(35, 'zW06h', 'UWMFOnOE', 'admin', 34, '2016-02-20 15:42:41', 0);
...
(34, 'Genelyn', 'Reyes', 'delos', 'female', '1992-02-29', 'Molave Zamboanga del Sur', '09065447789', '2016-02-20 15:42:42', 35);
