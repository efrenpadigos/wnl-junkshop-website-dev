	...
	<body>
			...
			<?php
							...
							if($_POST['cash'] < $_POST['total']){
								echo"<script>alert('Your payment is lacking.');window.location.href=''</script>";
								exit;
							}
...
<?php
	if(isset($_POST['submit'])){
		...
		if($_POST['price'] < $org_price){
			echo"<script>alert('Hey you will not earn much from your product because it's very cheap.');window.location.href=''</script>";
			exit;
		}
